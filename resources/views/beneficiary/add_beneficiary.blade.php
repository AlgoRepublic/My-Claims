                ...
                <form method="POST" action="{{ url('/beneficiary/add') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" data-type="mobile" id="reg-contact-no" data-source="beneficiary" pattern="\d*" maxlength="10" minlength="10" title="Length should be 10 digits | Only positive digits are allowed" class="form-control" name="bene_cell_number" placeholder="Enter Cell Number" required="">
